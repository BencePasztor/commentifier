...
export const ViewPost = () => {
  ...
  const { data: response, isSuccess, isFetching, isError, refetch } = useFetchPostBySlugQuery(slug as string)

  return (
    <Card className="p-0 xl:rounded-lg xl:container">
      {/* Loading */}
      {isFetching ? <div className="my-2 text-center"><Spinner /></div> : null}
      {/* Post Page */}
